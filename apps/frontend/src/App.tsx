import { SHARED_VERSION } from '@xeriusfit/shared';

/**
 * Placeholder only. Proves the build runs, Tailwind compiles, and the
 * @xeriusfit/shared workspace link resolves. No PRD screens or flows yet.
 */
export const App = (): React.JSX.Element => (
  <main className="flex h-full flex-col items-center justify-center bg-brand-surface">
    <h1 className="text-4xl font-semibold tracking-tight text-brand-primary">xeriusFit</h1>
